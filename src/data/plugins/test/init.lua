...
local TestPlugin = View:extend()

function TestPlugin:new()
  TestPlugin.super.new(self)
...
function TestPlugin:get_cached(item)
...
function TestPlugin:get_name()
  return "Project"
end


function TestPlugin:get_item_height()
  return style.font:get_height() + style.padding.y
end


function TestPlugin:check_cache()
...
function TestPlugin:on_mouse_moved(px, py)
...
function TestPlugin:on_mouse_pressed(button, x, y)
...
function TestPlugin:update()
  ...
  TestPlugin.super.update(self)
end


function TestPlugin:draw()
...
-- init
local view = TestPlugin()
local node = core.root_view:get_active_node()
node:split("left", view, true)

-- register commands and keymap
command.add(nil, {
  ["testplugin:toggle"] = function()
    view.visible = not view.visible
  end,
})

keymap.add { ["ctrl+\\"] = "testplugin:toggle" }
...
if has_menu and has_fsutils then
  ...
  -- general region of the testplugin
